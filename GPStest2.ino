...
void printGpsBuffer()
{
  if (Save_Data.isParseData)
  {
    ...
    if (Save_Data.isUsefull)
    {
      ...
      DebugSerial.print("速度= ");
      mSpeedKm = atof(Save_Data.mSpeed) * 1.6093 ;
      DebugSerial.println(mSpeedKm);
      ...
      else
      {
        ...
        if ((subStringNext = strstr(subString, ",")) != NULL)
        {
          ...
          switch (i)
          {
            ...
            case 7: memcpy(Save_Data.mSpeed, subString, subStringNext - subString); break; //速度
